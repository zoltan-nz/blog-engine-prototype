...
import { list_sites, create_site, preview_site, stop_preview } from './handlers/sites.js';
...
const serviceHandlers = { healthz, list_sites, create_site, preview_site, stop_preview };
