...
use crate::handlers::sites::{
    ...
    __path_stop_preview, CreateSiteRequest, SiteData, SiteListResponse, SiteResponse,
};
use utoipa::OpenApi;
...
#[openapi(
    ...
    paths(healthz, list_sites, create_site, delete_site, preview_site, stop_preview),
    components(schemas(
